...
// Questa procedura � inclusa in CalcClassifica
// 
...
*/
	//  assegna i punti MP alle coppie per il turno-board attuale
		...
		for($iOrient=0; $iOrient<2 ; $iOrient++) {
			...
			$Ngiocate= 0;
			for($iCoppia=0; $iCoppia<$Ncoppie ; $iCoppia++)    {
				if($iOrient==$RisMani[$ORIENT][$iCoppia])  {   			// tempScore pu� essere -1 !! 0 sta per all-pass
...
echo "<br>" ;
*/
			// pi� uno per i punteggi uguali
			// pi� due per i punteggi minori		
...
//   !!!!!!   ATTENZIONE    MODIFICA IMPORTANTE A ALL PASS
				...
				//  = 0		  ALL PASS				: SI ASSEGNA 50% DEL TOP A CHI � PASSATO. SE UNA SOLA COPPIA HA GIOCATO, SI ASSEGNA TOP O ZERO A SECONDA	
