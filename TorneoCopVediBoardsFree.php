...
<meta http-equiv='pragma' content='no-cache'>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Mostra altri risultati</title>
	<meta http-equiv="X-UA-Compatible" content="IE=10" />
	<meta name="description" content="mostra altri">
...
//  CONTROLLA LA PRESENZA DEL TORNEO INSERITO NELLA TABELLA brdg_ind_tornei
	...
	//****************************************	
	if($azione=="Vai")  {
		//if(strlen($board)==1)	$board= "0".$board;     portato dentro VediFoto
	  	header("Location:".$home_archive."/VediFoto.php?torneo=$NomeTorneo&turno=$turno&tavolo=$NumTavolo&board=$board&orig=Giocatore");
		exit();
	}
	//*******************************
...
//------------------------------------------------------
	...
	echo  "<br>";
//------------------------------------------------------
//<button style="background-color:LightGray;align:center;" onclick= echo $AzioneBottone; ; ">Indietro</button>
...
?>
	...
	<script>
    function torna() {
	   window.location.href = 'TorneoCopScoresContrattoTav.php?NomeTorneo=<?php echo $NomeTorneo; ?>&NumTurno=<?php echo $turno; ?>&tavolo=<?php echo $NumTavolo; ?>&orig=risultati';
    }
	</script>
 
  <form action="TorneoCopVediBoardsFree.php?NomeTorneo=<?php echo $NomeTorneo; ?>&NumTurno=<?php echo $turno; ?>&tavolo=<?php echo $NumTavolo; ?>" method="post">	
	...
	<table style="HEIGHT: 10px" width="10" align="center" border="1">
      <tbody>
        <tr align="center">
         <td ><button style="background-color:LightGray;align:center; font-size:32px;" onclick="torna()">Indietro</button></td>		 
        </tr>
      </tbody>
    </table>
